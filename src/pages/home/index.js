...
const HomePage = () => {
  return (
    <>
        ...
        <EndSection>
          ...
          <NewsletterSection>
            <Text size="l" color="red">
              subscribe to Hedonic <br />Reversal newsletter
            </Text>
          </NewsletterSection>
        </EndSection>
      </ExploreSection>
      <DistributionSection>
        <Text align="center">
          Hedonic Reversal is distributed worldwide
          <br />
          exclusively by <Text display="inline" color="red">Envelope Estructure</Text>
        </Text>
      </DistributionSection>
    </>
  );
